  ...
  //        the DAWG after it's been created
	public static void main(String args[]) {
		...
		try {            
            ...
            ObjectInputStream my_in = new ObjectInputStream(new FileInputStream("Min_Trie_P.out"));
        ...
        try {
            	ObjectOutputStream my_out = new ObjectOutputStream(new FileOutputStream("Dict_DAWG_P.out"));
            	my_out.writeObject(my_dawg);
            	my_out.close();
            
            	System.out.println("Testing Serialized DAWG:");
            	ObjectInputStream my_in = new ObjectInputStream(new FileInputStream("Dict_DAWG_P.out"));
